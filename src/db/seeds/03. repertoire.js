  ...
  .insert([
    {
      ...
      composer_id: knex('people').where({ surname: 'Korngold' }).select('id'),
    ...
    },
    {
      ...
      composer_id: knex('people').where({ surname: 'Britten' }).select('id'),
    ...
    },
    {
      ...
      composer_id: knex('people').where({ surname: 'Mozart' }).select('id'),
    ...
    },
    {
      ...
      composer_id: knex('people').where({ surname: 'Wagner' }).select('id'),
    ...
    },
    {
      ...
      composer_id: knex('people').where({ surname: 'Donizetti' }).select('id'),
